...
import ru.practicum.shareit.user.dto.FromServerUserDto;
...
public class UserController {
    ...
    @PostMapping
    public FromServerUserDto createUser(@RequestBody User user) {
        ...
        return UserDtoMapper.transformToFromServerDto(createdUser);
    }

    @GetMapping("/{userId}")
    public FromServerUserDto getUser(@PathVariable long userId) {
        ...
        return UserDtoMapper.transformToFromServerDto(requestedUser);
    }

    @PatchMapping("/{userId}")
    public FromServerUserDto patchUser(@PathVariable("userId") String userIdString, @RequestBody User user) {
        ...
        return UserDtoMapper.transformToFromServerDto(result);
    }
