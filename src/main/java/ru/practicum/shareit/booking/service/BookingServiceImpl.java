...
public class BookingServiceImpl implements BookingService {
    ...
    public List<Booking> getUsersBookings(BookingFilterValues bookingFilterValue,
                                          long userId,
    ...
    public List<Booking> getBookingsOfUsersItems(BookingFilterValues bookingFilterValue,
                                                 long userId,
                                                 Sort.Direction sortOrder) {
        userValidator.validateExists(userId);
        return filterAndSortBookings("start",
    ...
    private List<Booking> filterAndSortBookings(String bookingSortingProperty,
                                                Sort.Direction sortOrder,
                                                BookingFilterValues bookingFilterValue,
    ...
    private BooleanExpression byValue(BookingFilterValues bookingFilterValue) {
